...
export default function BlogPost1() {
  return (
    <>
      <SEO 
        title="Interview Coder: Controversy and Transformation in Technical Interview Tools - Interview Pilot Blog"
        description="An in-depth look at the evolution of Interview Coder and its impact on technical interview practices"
      />
      <Section>
        <Container maxW="container.xl" py={16}>
          ...
          <Box mb={12}>
            ...
            <Box pl={6} mb={6}>
              <Text mb={3}>• Complete invisibility to screen recording software</Text>
              <Text mb={3}>• Ability to toggle the application window without losing cursor focus</Text>
              <Text mb={3}>• Step-by-step solution explanations with commented code</Text>
              <Text mb={3}>• Functionality to position the window as an overlay on code editors</Text>
              <Text mb={3}>• Keyboard shortcuts to capture problems and generate solutions</Text>
            </Box>
          </Box>
          ...
          <Box mb={12}>
            ...
            <Box mb={6}>
              <Text mb={3} fontWeight="bold">New Company and Funding:</Text>
              <Text mb={6} pl={4}>
              ...
              <Text mb={3} fontWeight="bold">Expanded Mission:</Text>
              <Text mb={6} pl={4}>
          ...
          <Box borderTop="1px" borderColor="gray.200" pt={8} mt={12} fontSize="sm" color="muted">
            <Text>
